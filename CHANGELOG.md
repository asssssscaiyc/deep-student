...
## [0.9.39](https://github.com/asssssscaiyc/deep-student/compare/v0.9.38...v0.9.39) (2026-05-25)


### Features

* add academic search tool with arXiv + OpenAlex integration ([1ae5c24](https://github.com/asssssscaiyc/deep-student/commit/1ae5c24534afe33addc0980801bde18869b79e4a))
* add Android build to release workflow + bump VERSION_CODE_BASE to 13000 ([54c0d22](https://github.com/asssssscaiyc/deep-student/commit/54c0d22407b305c32df90a9848225637f4c9fe4f))
* add attachment pipeline automated test plugin ([371e5c5](https://github.com/asssssscaiyc/deep-student/commit/371e5c5a6f830475cffb70f65480c2c17153495b))
* add backup cancellation support and fix attachment base64 detection ([5b3361e](https://github.com/asssssscaiyc/deep-student/commit/5b3361e821ba28997ebcf3c79ec7ec52cadf8c18))
* add build support for linux ([#41](https://github.com/asssssscaiyc/deep-student/issues/41)) ([1d253f2](https://github.com/asssssscaiyc/deep-student/commit/1d253f25e78aaf7f3c906943bd30e332059ab4a1))
* add ChatAnki integration test plugin for automated testing ([fc20b15](https://github.com/asssssscaiyc/deep-student/commit/fc20b15f47590cfe3a21dc813821f16125596b0d))
* add data visualization APIs for OCR and text chunk management ([d1b7ae4](https://github.com/asssssscaiyc/deep-student/commit/d1b7ae4b74f5deb9d5cf564e88c72197e1164083))
* add database maintenance mode + fix Windows file lock (OS error 32) during restore ([7023510](https://github.com/asssssscaiyc/deep-student/commit/7023510b76afcb23149ba0271e9c020c102c9608))
* add development scripts for Android environment setup ([ab2953f](https://github.com/asssssscaiyc/deep-student/commit/ab2953f4bd35ea1ba657154063ff72bf5dcd4d27))
* add DOCX VLM direct extraction path with streaming and checkpoint recovery ([2ee580f](https://github.com/asssssscaiyc/deep-student/commit/2ee580fd8f8465e9a6b867bc505a3e71f38f1fd4))
* add GitHub Actions workflow for rebuilding Android APK ([1285e99](https://github.com/asssssscaiyc/deep-student/commit/1285e99643d8f26d61ef2e91d91e11a502e8bd75))
* add image payload parsing and handling utilities ([a16033e](https://github.com/asssssscaiyc/deep-student/commit/a16033ef6a27041d11de2a743a5c74f91a013079))
* add memory audit log functionality and enhance memory management ([24cb17b](https://github.com/asssssscaiyc/deep-student/commit/24cb17ba77e7f37b30506cd6bae10457a27e7f16))
* add multi-tab support with LRU eviction, fix cross-tab event pollution, and enhance LaTeX rendering ([8b349fe](https://github.com/asssssscaiyc/deep-student/commit/8b349fefa8ef9d64186b4e6208f869b045401d89))
* add native DOCX import with embedded image support ([304d940](https://github.com/asssssscaiyc/deep-student/commit/304d940663577171f8542db8b86e869f2f1274c4))
* add orphan OCR engine cleanup + improve file save UX + fix test engine selection ([b080582](https://github.com/asssssscaiyc/deep-student/commit/b08058212f4cb360ba87bf96dd41721eb772fc37))
* add paper save + citation formatting tools with VFS integration ([176aae2](https://github.com/asssssscaiyc/deep-student/commit/176aae2b49fd03b3d6ed0a4c636fa08e644e5aaf))
* add rebuild-release workflow for manual tag rebuilding ([3d28fec](https://github.com/asssssscaiyc/deep-student/commit/3d28fec4f6c5fefb794fef3ed2bf2e016a436fb4))
* **ankiCards:** enhance event handling and error reporting ([6f2642c](https://github.com/asssssscaiyc/deep-student/commit/6f2642c428e1dd2512559f1bb14b6faa20a097ba))
* **chat_v2,workspace,qbank,sync:** add cross-session permission checks and harden tool whitelist bypass ([04a9b10](https://github.com/asssssscaiyc/deep-student/commit/04a9b10ac9b8a446f811dfc06b5915f386a0a956))
* **chat-v2,learning-hub:** enhance resource handling and state management ([168c253](https://github.com/asssssscaiyc/deep-student/commit/168c253780c9833c2fd0d6d3e19e63dbe76893f1))
* **chat-v2:** add disable_tool_whitelist option to bypass skill whitelist restrictions ([be13c97](https://github.com/asssssscaiyc/deep-student/commit/be13c9749874ef2b3369fa7da1fba594f693b798))
* **chat-v2:** add session branching and group pinned resources support ([e56189a](https://github.com/asssssscaiyc/deep-student/commit/e56189ae77cfafbc045a793a20c19653ac7e4444))
* **chat-v2:** enhance skill state management and event handling ([3c8027a](https://github.com/asssssscaiyc/deep-student/commit/3c8027aaada91c74f8a98de4b3e915a504f1ffb2))
* **chat-v2:** use dedicated chat_title_model for summary generation with fallback chain ([3759861](https://github.com/asssssscaiyc/deep-student/commit/3759861ebecfa15ee28747f6fc9818d3d687c2c5))
* **chat,vfs:** add answer submission idempotency and enhance context ref handling ([580db0f](https://github.com/asssssscaiyc/deep-student/commit/580db0f271f6ad3a03cc18b136e592437a3960cf))
* **cloud-sync:** add real-time upload/download progress events and workspace database backup support ([c9d4bf7](https://github.com/asssssscaiyc/deep-student/commit/c9d4bf7f6d187d479a5fc646326e8a8f88f7d233))
* cross-platform pdfium fixes + system OCR adapters + platform-specific resource bundling ([ea87e01](https://github.com/asssssscaiyc/deep-student/commit/ea87e015a84e1da8c5ed32b9679de0d7298f9db1))
* **data_governance:** support virtual URI targets for ZIP exports ([b5bd171](https://github.com/asssssscaiyc/deep-student/commit/b5bd171fb5a8c16f71797c5bf191c5e25e31a320))
* **debug:** implement debug log persistence and filtering options ([fa8f4c9](https://github.com/asssssscaiyc/deep-student/commit/fa8f4c9fc99f98ff082890a37beb51ffecbcea5f))
* enhance Anki card handling with action locks, pagination, and improved error handling ([bf5f2bd](https://github.com/asssssscaiyc/deep-student/commit/bf5f2bd189750f8bd971486fce6ea5673323ec21))
* enhance backup functionality with ImportProgress struct and refactor auto backup logic ([a33f2d9](https://github.com/asssssscaiyc/deep-student/commit/a33f2d9a5db03e2a467a834cf064d17f0efe890c))
* enhance bidirectional sync with download-first strategy and improved conflict handling ([4fb78e3](https://github.com/asssssscaiyc/deep-student/commit/4fb78e30737575bdbfafab6c24d432b6939754e0))
* enhance file handling with new extraction utilities ([be86d16](https://github.com/asssssscaiyc/deep-student/commit/be86d166798455d99cd142808f1c676c4f9cd1a5))
* enhance file name handling and import error reporting ([c167b25](https://github.com/asssssscaiyc/deep-student/commit/c167b253ee06637c9752ab8437bc30b6d6f9a801))
* enhance image preview handling and improve NoteContentView layout ([ffe392b](https://github.com/asssssscaiyc/deep-student/commit/ffe392bd44da32a28dd9f5725b335dc3bad6492c))
* enhance memory management with auto extraction and category management ([0b5d8fb](https://github.com/asssssscaiyc/deep-student/commit/0b5d8fb83158b2811d696852cb6fc7bd07446ace))
* enhance memory management with new relation and tagging features ([d7dc855](https://github.com/asssssscaiyc/deep-student/commit/d7dc8559ee47cdc253a9f71dbe2998808cf774ad))
* enhance memory management with new settings and export functionality ([2b48b71](https://github.com/asssssscaiyc/deep-student/commit/2b48b71e3c33e14ec85fb6f8396d4bdca04dbf18))
* enhance MemoryView with batch selection and editing capabilities ([788147e](https://github.com/asssssscaiyc/deep-student/commit/788147e992bdd368b465253308920c7e78eb1402))
* enhance model capability registry and update related scripts ([9caea57](https://github.com/asssssscaiyc/deep-student/commit/9caea57694f947c92abca1d5bd02cd4eb24c1697))
* enhance progress tracking for backup/restore/import operations with detailed error reporting ([39502db](https://github.com/asssssscaiyc/deep-student/commit/39502dbac74a64b701e988a75a6976f1d6fb8111))
* enhance SiliconFlowSection with new OCR model and improve backup functionality ([c5ab6d4](https://github.com/asssssscaiyc/deep-student/commit/c5ab6d4b1cc9efebe89163c937af53555f48dcc8))
* enhance Smart Memory with self-evolving profile and auto-extraction features ([c29005a](https://github.com/asssssscaiyc/deep-student/commit/c29005af5e17da3c985bc99e9e510acdddb9d8c5))
* enhance sync functionality with merge strategy and timestamp parsing ([274a81e](https://github.com/asssssscaiyc/deep-student/commit/274a81ec49a88803d22fd6be6be40d184f813d76))
* enhance tool handling, sleep wake logic, and crypto key backup/restore ([6d27862](https://github.com/asssssscaiyc/deep-student/commit/6d278624be4bd2454753c88b29fb3cf80f7876ee))
* enhance web search tool with dynamic engine injection ([66b5902](https://github.com/asssssscaiyc/deep-student/commit/66b590205b828a47f0b449f3b2bd0a608bd6e960))
* **essay-grading:** refine grading mode rubrics and implement progressive hedging for OCR fallback ([9f1c09a](https://github.com/asssssscaiyc/deep-student/commit/9f1c09a3482aa123e95703a00754075f63642d18))
* **exam:** enhance exam XML generation and qbank tools ([fc80777](https://github.com/asssssscaiyc/deep-student/commit/fc8077744d99fe66d420552401a69753d6d1b4c6))
* fix tool call handling and user message deduplication in chat history ([6b38748](https://github.com/asssssscaiyc/deep-student/commit/6b3874895b00d1a15dc3d7d87fd0d3fc9f5fe2ff))
* **gemini,chat-v2,notes,providers:** enhance multimodal handling, cache tokens, and batch import cleanup ([b287a23](https://github.com/asssssscaiyc/deep-student/commit/b287a237563db711c79e6bda9e7b2933717e6a65))
* **gemini,memory,llm:** add frequency/presence penalties, batch memory write, and provider_scope routing ([958979c](https://github.com/asssssscaiyc/deep-student/commit/958979c40c4fee5e82e4c9b5cf5161fbb4df8ba0))
* **i18n:** add Todo localization support for en-US and zh-CN ([e61ee8e](https://github.com/asssssscaiyc/deep-student/commit/e61ee8e561e99ca44fe7b57bac283ad7eaa35494))
* implement auto-extract frequency settings for memory management ([69a5990](https://github.com/asssssscaiyc/deep-student/commit/69a59905f934cad14416c86571ab4fb20f49193f))
* implement automatic migration for GLM-4.1V to GLM-4.6V model ([2d194d9](https://github.com/asssssscaiyc/deep-student/commit/2d194d9b35598a1146f418901d02594aa4ff5123))
* implement block and message actions for enhanced chat functionality ([e68df84](https://github.com/asssssscaiyc/deep-student/commit/e68df84be6dfc0bf9fface0ebfda9929fff25d0e))
* implement content search and session tagging system ([cb846b5](https://github.com/asssssscaiyc/deep-student/commit/cb846b51741e4fad7ce31d4dfcc0224eba94ff50))
* implement CORS-compliant fetch function for mobile platforms in useAppUpdater ([8206224](https://github.com/asssssscaiyc/deep-student/commit/8206224ebae1a6efc9afa0689d7559be7c2cb46a))
* implement resource export system with format-specific adapters ([ed6f8f8](https://github.com/asssssscaiyc/deep-student/commit/ed6f8f834025b6e5356708948c05556c43c60f1e))
* improve mobile UI layout + migrate template buttons to NotionButton ([afd62b4](https://github.com/asssssscaiyc/deep-student/commit/afd62b4bb278f8790ff9918e0080e6d8cc36939f))
* **indexing:** 一键索引自动对预处理未完成的教材/PDF文件执行OCR ([2af03f4](https://github.com/asssssscaiyc/deep-student/commit/2af03f4de3ed8777ccd59c0fff5423dbd483a125))
* integrate release-please for automated release management ([69db429](https://github.com/asssssscaiyc/deep-student/commit/69db42973bf69849e730f25a61d80129a3b767ce))
* introduce release channel management and update README ([4c47987](https://github.com/asssssscaiyc/deep-student/commit/4c4798752fa69436f9e16939d015ea2495cc4045))
* **llm:** add model capability registry with automatic vision/tools/reasoning inference ([837aa6c](https://github.com/asssssscaiyc/deep-student/commit/837aa6ce338d2f9bbd20d98555906b93987249c1))
* **memory-system:** hide system-reserved folders/notes with `__*__` pattern across Finder and implement memory folder navigation ([7ddf4c3](https://github.com/asssssscaiyc/deep-student/commit/7ddf4c3c743a581f25ef72ba36afd3973e8b98f7))
* **memory:** implement write idempotency and enhance data integrity ([bb18278](https://github.com/asssssscaiyc/deep-student/commit/bb1827852b4018fd51de1c3bd78f6368447413d0))
* **mindmap:** add rich text formatting toolbar and emoji picker, improve node styling and export ([8630e3b](https://github.com/asssssscaiyc/deep-student/commit/8630e3b9cc0cc61de4b4cc109a6285e216bb3d47))
* mobile dual download links (R2 mirror + GitHub) ([0b4e4e5](https://github.com/asssssscaiyc/deep-student/commit/0b4e4e55aa3a1ebd79cff527e9fca4f570e674a2))
* **notes,textbooks:** detect and sanitize opaque Android document IDs in filenames across frontend and backend ([d75ac97](https://github.com/asssssscaiyc/deep-student/commit/d75ac976eea724243ed1473bb54b3910fd681669))
* **notes,textbooks:** extract H1 heading from markdown when title is generic placeholder and generate friendly names for opaque document IDs ([c62a022](https://github.com/asssssscaiyc/deep-student/commit/c62a022aad40ac6da8f2567402038762bcee778a))
* **notes:** add reading mode toggle to prevent keyboard popup on mobile during scrolling ([648d763](https://github.com/asssssscaiyc/deep-student/commit/648d7636eea2d9d11d0f22effc8922351f91582e))
* **ocr:** add FreeOCR fallback chain with circuit breaker and streamline grading mode prompts ([3fbd852](https://github.com/asssssscaiyc/deep-student/commit/3fbd852315698344e2675298e0f6dbf777daa14f))
* **pdf,polyfills:** add Promise.withResolvers polyfill for older browsers and remove unused active feature chips ([aebf481](https://github.com/asssssscaiyc/deep-student/commit/aebf481d35dd6907e0f380df04c04f7ad6fc50ce))
* **pomodoro:** add immersive focus mode with white noise and circular progress ([2ee581c](https://github.com/asssssscaiyc/deep-student/commit/2ee581cc41cc55f2053811e414a27310c872d7e0))
* **pomodoro:** add Pomodoro timer support for todo items ([6ad54d9](https://github.com/asssssscaiyc/deep-student/commit/6ad54d9765f0e7bd7c903525672cd1ba724c3ae8))
* prioritize R2 mirror for auto-update source ([f9c3b35](https://github.com/asssssscaiyc/deep-student/commit/f9c3b35ccad0854eda00e3f18f2bcc7cd4b8a190))
* **question-bank:** add question history view and refactor timer management for advanced practice modes ([36746a8](https://github.com/asssssscaiyc/deep-student/commit/36746a8f124c82d93f61ec95c0723df7d27fdd41))
* **session-management:** introduce session management tools and enhance request handling ([8d26ddb](https://github.com/asssssscaiyc/deep-student/commit/8d26ddb4eea67203a6fe18d595bc12b8d6014215))
* **settings:** add vendor model batch import and refactor essay grading settings panel ([e6379fd](https://github.com/asssssscaiyc/deep-student/commit/e6379fd708a757fe2d0e2510ec7ffc29a76db97b))
* **skills-executor:** add custom deserializer to handle stringified array parameters from LLMs ([493677f](https://github.com/asssssscaiyc/deep-student/commit/493677fe7145a27014ba358ec5ffc3f74969151a))
* source image crop, search snippets, remove question_parsing_model ([9ed6315](https://github.com/asssssscaiyc/deep-student/commit/9ed6315c43432eaf80aa5d588e2cf52367e7277f))
* standardize Tauri v2 parameter naming to camelCase for automatic snake_case mapping ([64f541c](https://github.com/asssssscaiyc/deep-student/commit/64f541cbd6d81ce4e03134727678cdcb4362380f))
* **sync:** add workspace database and VFS blob file-level cloud sync support ([9dc08b5](https://github.com/asssssscaiyc/deep-student/commit/9dc08b58e2570aba3076bb3d50e64cd4dfdb9ea0))
* **todo:** add comprehensive Todo support across DSTU system ([3863cf9](https://github.com/asssssscaiyc/deep-student/commit/3863cf9384fc327dc6b27a089e8438ca4f1a61db))
* **todo:** add database constraints and improve code formatting ([2500b9c](https://github.com/asssssscaiyc/deep-student/commit/2500b9ce34550b131eeb3775da7658c74bd211d9))
* **todo:** add Todo resource type support across Learning Hub ([b8e418d](https://github.com/asssssscaiyc/deep-student/commit/b8e418dd7225cf48c549c0ed419918da065bb21d))
* **todo:** add user-facing todo system with database schema and system prompt integration ([ba1dfa4](https://github.com/asssssscaiyc/deep-student/commit/ba1dfa471a1c6ea49c640047e17a41525768a9e9))
* **tools:** add arg_utils for JSON parsing and MCP server configuration ([44c70b4](https://github.com/asssssscaiyc/deep-student/commit/44c70b4570bffbd087c573ee9be2c37dd1940542))
* **tools:** add DOCX document read/write tool executor + Excel/PowerPoint dependencies ([2a7546a](https://github.com/asssssscaiyc/deep-student/commit/2a7546a942b55d8bbf163f6e22ea9239d1baf988))
* **tools:** add PPTX/XLSX tool executors with full read/write capabilities ([d3f6bc5](https://github.com/asssssscaiyc/deep-student/commit/d3f6bc52d5899a7def675f16adb815bd08536421))
* update OCR model configurations and enhance engine selection logic ([30097ec](https://github.com/asssssscaiyc/deep-student/commit/30097ecdb58b9cb24cb3bc03bf32c6b9f55dea7d))
* **vfs:** decouple todo_lists from VFS resources system ([2be0e94](https://github.com/asssssscaiyc/deep-student/commit/2be0e943b263a0b544009c26f9b4a0121ff1cb4a))
* **vfs:** filter deleted/inactive resources in index status queries and add question filtering in exam uploader ([434fad1](https://github.com/asssssscaiyc/deep-student/commit/434fad13f1cd6c66925ea9ef3fa2d308d4629595))
* **vfs:** mark resource as pending after successful unit sync ([77c24f1](https://github.com/asssssscaiyc/deep-student/commit/77c24f1218f402e0290b3de5bc8f199d0ebb3454))
* **workflows:** add hotfix workflow for Linux release assets and improve sync reliability ([4b7a71f](https://github.com/asssssscaiyc/deep-student/commit/4b7a71fbdc42fec4adc872c86b874713161e6739))
* 题目集导入断点续导（checkpoint resume） ([4b4da2d](https://github.com/asssssscaiyc/deep-student/commit/4b4da2df3f1e723707bccd793c993f20754ac0f7))


### Bug Fixes

* add --remote flag to wrangler r2 commands ([2ede0e7](https://github.com/asssssscaiyc/deep-student/commit/2ede0e72cf00a51f2335c58c02d4d21d6e7ad9b3))
* add @lobehub/ui and antd dependencies ([c2f43f8](https://github.com/asssssscaiyc/deep-student/commit/c2f43f8bfd16624491b2ba4d9bc892ffc9515142))
* add empty string clearing for group fields + validate group existence + cleanup vector indices on delete/purge ([754da80](https://github.com/asssssscaiyc/deep-student/commit/754da807a666d8cf4fe80a901638aa2f3c66999d))
* add execute right for build_linux_all.sh ([1d253f2](https://github.com/asssssscaiyc/deep-student/commit/1d253f25e78aaf7f3c906943bd30e332059ab4a1))
* add fallback logic for empty Anki back field and replace custom scrollbars with CustomScrollArea ([341c9dc](https://github.com/asssssscaiyc/deep-student/commit/341c9dc6be4553dff604b9192f8a5bbf92714961))
* add generate-version.mjs to all platform builds + update committed version ([2f0cfec](https://github.com/asssssscaiyc/deep-student/commit/2f0cfec870d15e29f1ef2ec4082b13ba2109ddc1))
* add process:default capability + harden semver comparison ([78bff18](https://github.com/asssssscaiyc/deep-student/commit/78bff1854e0a2c4b1fb8d3373b986013e2885b09))
* add protoc install for macOS (brew) and Windows (choco) in release builds ([69e67f0](https://github.com/asssssscaiyc/deep-student/commit/69e67f0113f99ba9410de90d1ef32966d128b085))
* address verified P0/P1 issues from code audit ([0910daa](https://github.com/asssssscaiyc/deep-student/commit/0910daa38424c37a375a7b9b7df1a84b630a7858))
* **android-files:** support virtual URI import export flows ([58c4234](https://github.com/asssssscaiyc/deep-student/commit/58c4234762a9fa1eec6c7b3f0672069384c1c646))
* **android:** disable ppt-rs default features to avoid openssl-sys ([43c3b66](https://github.com/asssssscaiyc/deep-student/commit/43c3b66c3f4e8bdfa51fbd8538e17c1e809e722f))
* **android:** replace navigator.clipboard with tauri-plugin-clipboard-manager ([80c40fa](https://github.com/asssssscaiyc/deep-student/commit/80c40fa2f93e2a1e6c893b5dc11d23948976a42e))
* **build:** bump Android versionCode to 13516 and add parse_timestamp import ([045703e](https://github.com/asssssscaiyc/deep-student/commit/045703ef5c454dcce0da62405fab03bc48b5dce2))
* bump VERSION_CODE_BASE to 10000 + Node 22 + memory fix for release builds ([8143f02](https://github.com/asssssscaiyc/deep-student/commit/8143f02c424ddf2c59973fea27c97e15f8837662))
* **chat-v2:** enforce explicit model resolution for multimodal injection ([be308bf](https://github.com/asssssscaiyc/deep-student/commit/be308bf67f0eeb7a3bc14cbf4ef23e7874428434))
* **chat-v2:** ensure active skills content is always passed to backend for synthetic load_skills injection ([5464f52](https://github.com/asssssscaiyc/deep-student/commit/5464f525a50565783a8bf02c7b833ce1ecbfb49f))
* **chat-v2:** fix continue message error handling and builtin model badge display logic ([c08b30f](https://github.com/asssssscaiyc/deep-student/commit/c08b30fbe010e9c77b104967d87334ec35876632))
* **chat-v2:** reorder session branching DB writes to satisfy FK constraints and refactor resource picker UI ([2e620ba](https://github.com/asssssscaiyc/deep-student/commit/2e620ba96614b8118bb0e0db073edc2550585b70))
* **chat:** change SessionCard height from fixed to min-height ([cbb156d](https://github.com/asssssscaiyc/deep-student/commit/cbb156d89011d51c550762aac35bf142aff725ae))
* **ci:** add three-path release detection to handle merge commits burying release commit ([466152c](https://github.com/asssssscaiyc/deep-student/commit/466152c651918718833dbf311a4307ed345fe4c6))
* **ci:** auto-recover android release builds ([ac74c9b](https://github.com/asssssscaiyc/deep-student/commit/ac74c9be414f2a4b61f22224cfccec7b6d2cf829))
* **ci:** avoid android rebuild invalidation and add heartbeat ([4740877](https://github.com/asssssscaiyc/deep-student/commit/4740877946eafdabf55c6382c440e4f5be1391e3))
* **ci:** avoid duplicate release creation blocking release-please ([21998cc](https://github.com/asssssscaiyc/deep-student/commit/21998cc530f566e3d10f40f9e4097578d0c97194))
* **ci:** detect merged release commits with PR suffix ([14547bb](https://github.com/asssssscaiyc/deep-student/commit/14547bbc726bcabaf4960e2c085582f36b6cb35c))
* **ci:** harden Android build against runner resource exhaustion ([985bc7b](https://github.com/asssssscaiyc/deep-student/commit/985bc7bc9f7ad4ced66d5d97e56fad3248024ec5))
* **ci:** prevent dependabot major bumps + precise semver extraction ([394deff](https://github.com/asssssscaiyc/deep-student/commit/394deff5acd3ff51c8ae2725aba0051b524f11a2))
* **ci:** remove android tee wrapper and add timeout ([79df4e0](https://github.com/asssssscaiyc/deep-student/commit/79df4e0813b5b3ee405105bda57e45fe96e1b097))
* **ci:** retry transient android dependency failures ([3734c5c](https://github.com/asssssscaiyc/deep-student/commit/3734c5ce3c5612d6dc65c2cedee84d72da6a88f0))
* copy custom Android icons after tauri android init in CI ([f69ab56](https://github.com/asssssscaiyc/deep-student/commit/f69ab56cb6a45d9d15247c23ea7a13c4725a52a2))
* correct field references and add missing impl block in debug logger ([13bb819](https://github.com/asssssscaiyc/deep-student/commit/13bb8194c7d12c9f7a4083c4dacb352a83a54c81))
* correct SQL LIKE pattern escape syntax in note query ([8d96e08](https://github.com/asssssscaiyc/deep-student/commit/8d96e08bc5bc5cca947e58f7446db68049a7dc2d))
* critical review fixes for R2 upload in release workflow ([2e2b32d](https://github.com/asssssscaiyc/deep-student/commit/2e2b32db321d44e30a5ac6eab9e23689b01e796c))
* **deps:** migrate json_validator to jsonschema 0.42 API ([7749723](https://github.com/asssssscaiyc/deep-student/commit/774972354c50dc9115066c655d3d6b2ca257bfc2))
* downgrade pdfium to 7350 + add diagnostic command + repair stale PDF cache + harden ready_modes validation ([92a317c](https://github.com/asssssscaiyc/deep-student/commit/92a317c8d6c6c82019d596a38ee3d6df0fa974c2))
* enable createUpdaterArtifacts for Tauri v2 updater ([6ca2e5c](https://github.com/asssssscaiyc/deep-student/commit/6ca2e5c0410fddc07f91e09d7c581113b845cd52))
* enhance error handling and performance optimizations in Chat V2 ([25541cb](https://github.com/asssssscaiyc/deep-student/commit/25541cb990beedbb7776447a2dd554b1515cc99e))
* **essay-grading:** replace description Input with textarea for multi-line mode descriptions ([1be61db](https://github.com/asssssscaiyc/deep-student/commit/1be61db9512ae4cc117f928025752c66ac7988be))
* gate desktop_dir/picture_dir with #[cfg(desktop)] for Android build ([f02f1b3](https://github.com/asssssscaiyc/deep-student/commit/f02f1b3e058023d5c062cdafbbeed95f78c57dbb))
* **gemini:** add thought_signature support for Gemini 3 tool calling and enforce role alternation ([4559644](https://github.com/asssssscaiyc/deep-student/commit/45596441ffb24d5ae6b5fd0dc7544f15b1c205b0))
* **gemini:** force v1beta for Gemini 3 models and convert unprotected functionCalls to text ([12d3156](https://github.com/asssssscaiyc/deep-student/commit/12d3156e0342dea0b62e10aff6e862a78fa8cd54))
* handle release-please comment failure on locked PRs ([6df5ff8](https://github.com/asssssscaiyc/deep-student/commit/6df5ff895eb80e93157e58f82355821ebf29c494))
* harden migration backup validation + auto-backfill PDF processing status + improve test plugin model handling ([1e23842](https://github.com/asssssscaiyc/deep-student/commit/1e238422f6def557b8b1b498a156eed8b51a3ed4))
* improve question import quality and blob path resolution ([aeb5608](https://github.com/asssssscaiyc/deep-student/commit/aeb5608115795efbbc99539878d2109ba2f29348))
* improve tool call argument parsing + add paper save fallback handling + add purge safety checks ([bf94e37](https://github.com/asssssscaiyc/deep-student/commit/bf94e3753fbed6c48450424e286d3da629fde6d2))
* improve tool schema parameter formats to reduce LLM confusion ([2b24b1e](https://github.com/asssssscaiyc/deep-student/commit/2b24b1ea7248ac25849f3b3db233b0475059957d))
* increase MCP cache max size for improved performance ([7896e76](https://github.com/asssssscaiyc/deep-student/commit/7896e76b09d87ed534041e48d43bd31b08be1cd9))
* **mcp:** audit compliance fixes - timeout alignment, connection state tracking, and DRY refactor ([814cb91](https://github.com/asssssscaiyc/deep-student/commit/814cb9189ed108567434ecdf4283fb0133c3d4bb))
* **mcp:** sanitize tool names for OpenAI API compatibility and improve memory retrieval ranking ([40bec6f](https://github.com/asssssscaiyc/deep-student/commit/40bec6f092a009f5e2481eb40f708a6da9cc1d0f))
* **memory:** enforce atomic fact storage and prevent knowledge/content leakage ([fd7a0c2](https://github.com/asssssscaiyc/deep-student/commit/fd7a0c29bd3d71cd0d904f367cf0f50c65fcfcbd))
* merge duplicate clipboardUtils import in useMindMapClipboard ([b747ec3](https://github.com/asssssscaiyc/deep-student/commit/b747ec328dedf19d932cb1f97d4fa12c6c07b7f0))
* mobile updater uses semver comparison instead of string inequality ([612c250](https://github.com/asssssscaiyc/deep-student/commit/612c25033d623d1eb4a8aef83fe306ee061491d5))
* pin @lobehub/icons to 5.6.0 ([d04fb13](https://github.com/asssssscaiyc/deep-student/commit/d04fb132ec29b081b93057cf20d11d750b130ebf))
* platform-aware auto-updater for all platforms ([29651ad](https://github.com/asssssscaiyc/deep-student/commit/29651ad3c1d58232d50b452fbb6d0e4740e04d7c))
* prevent action buttons from overlapping session title during edit ([5278d4b](https://github.com/asssssscaiyc/deep-student/commit/5278d4beacef6dfa1e63aa85619a490132bf804f))
* prevent duplicate text input during IME composition and sync skill whitelist after load_skills ([05be6b5](https://github.com/asssssscaiyc/deep-student/commit/05be6b53a1e392174058a3f9afc6e51256bbe942))
* prevent duplicate user messages in history and improve IME handling across platforms ([f903bd1](https://github.com/asssssscaiyc/deep-student/commit/f903bd18794722fbab566ae932e146cf54428143))
* **rebuild:** add --legacy-peer-deps to npm ci ([449a0c2](https://github.com/asssssscaiyc/deep-student/commit/449a0c2a71cdc0411e18dddaa98c62a757513724))
* release workflow critical fixes ([0c3b404](https://github.com/asssssscaiyc/deep-student/commit/0c3b404b599af69b5b4cee7ed7a1b1e4c22ae650))
* **release:** add --legacy-peer-deps to npm ci ([e0bb680](https://github.com/asssssscaiyc/deep-student/commit/e0bb680f32b451127962713f83a6641a4bbef371))
* **release:** disable component-prefixed tags + robust version extraction ([5b50a4b](https://github.com/asssssscaiyc/deep-student/commit/5b50a4b5777ce2ef1a1de1c02c40f55d76bc46ba))
* remove custom OCR prompts + harden attachment test plugin ([7c3e43d](https://github.com/asssssscaiyc/deep-student/commit/7c3e43de723620d35675e75b39ab10d03b709727))
* remove default Tauri drawables + restrict mobile.json to mobile platforms ([ca43bb3](https://github.com/asssssscaiyc/deep-student/commit/ca43bb3aa1560e1fc95424cd2d06c93a0ff12993))
* remove Gemini OpenAI compat mode special handling + add OCR diagnostic logging ([5063706](https://github.com/asssssscaiyc/deep-student/commit/50637067311e65a5ea173a4e57ddae0db2e3ca0b))
* rename macOS .app.tar.gz with arch suffix to prevent overwrite ([a7936cb](https://github.com/asssssscaiyc/deep-student/commit/a7936cb77bb6807481371f20be0f7d05a238ac04))
* resolve TypeScript errors in i18n fallbackLng and IndexStatusView ([00a438a](https://github.com/asssssscaiyc/deep-student/commit/00a438a597816de462e51c6e1ab8e58a65e91951))
* resolve TypeScript type errors in attachment audit logging ([499a41b](https://github.com/asssssscaiyc/deep-student/commit/499a41b5af3d8a34769a6b77cd9db37c5f22b1db))
* **restore:** 恢复备份写入非活跃插槽，避免 Windows OS error 32 ([af6c11f](https://github.com/asssssscaiyc/deep-student/commit/af6c11f89a51f47d88035172f83bf0a9f63f44e5))
* restrict desktop capabilities to desktop platforms + misc improvements ([6772c17](https://github.com/asssssscaiyc/deep-student/commit/6772c17932d553c8908acc562a8d2e81eaeac817))
* **settings:** prevent auto-save from overwriting backend config when loadConfig fails ([21fbb00](https://github.com/asssssscaiyc/deep-student/commit/21fbb00106e6408e8948f171e78153040fdeab39))
* show 'already up to date' feedback after manual update check ([e7b27fe](https://github.com/asssssscaiyc/deep-student/commit/e7b27fe2ccb6c44a3f3f6796f761895ec45e9e98))
* standardize snippet container heights using Tailwind spacing units ([5fe902d](https://github.com/asssssscaiyc/deep-student/commit/5fe902d0e60991ebe4aa1a80b597963220995833))
* switch to rclone for R2 upload (native Cloudflare provider) ([c20f5af](https://github.com/asssssscaiyc/deep-student/commit/c20f5afde9adc1fbfc9bf6cb43f6c9beafef1ded))
* switch to wrangler CLI for R2 upload (bypass S3 TLS issue) ([643b8ad](https://github.com/asssssscaiyc/deep-student/commit/643b8ad1866c1112f9461d1dca873f75dd207f9f))
* update links in README_EN.md for Quick Start and User Guide ([f4611a5](https://github.com/asssssscaiyc/deep-student/commit/f4611a5e61463fc88642d30763774b4213e16659))
* update model capabilities and context token limits ([545d645](https://github.com/asssssscaiyc/deep-student/commit/545d64551045f305139be231fa6621cbc4897a5e))
* update SiliconFlow website URLs in ApisTab and builtin_vendors ([aa2ad0d](https://github.com/asssssscaiyc/deep-student/commit/aa2ad0dcb6325b647d0ffbecd08b2047d5ec41c7))
* **updater:** robust version extraction from tag_name for Android ([0e13205](https://github.com/asssssscaiyc/deep-student/commit/0e132050c2dd04b1addc8075040cc3aef0fafe66))
* use adapter-transformed request body for LLM request logging ([a93ed02](https://github.com/asssssscaiyc/deep-student/commit/a93ed02f9e45c52352035628273196623894cac9))
* use arduino/setup-protoc, fail-fast false, remove redundant frontend build ([1ddf626](https://github.com/asssssscaiyc/deep-student/commit/1ddf6268e583e8a9bbda4afd26458ed28d335f34))
* use GitHub API for R2 version cleanup (wrangler has no list command) ([3f5903c](https://github.com/asssssscaiyc/deep-student/commit/3f5903c6b858d0044cd5734703e122b3f6f464ad))
* use path-style addressing for R2 S3 compatibility ([fa0157b](https://github.com/asssssscaiyc/deep-student/commit/fa0157b6a16b70f3c4d8efd0691b925f7fbea884))
* **web-search:** remove engine/force_engine from schema and add silent fallback for unconfigured engines ([c33ca0d](https://github.com/asssssscaiyc/deep-student/commit/c33ca0da55544acd0af369621ec2e0500bcfd0b4))
* 修正在学习资源内题库中答题结束的祝贺弹窗在移动端的错误位置 ([#51](https://github.com/asssssscaiyc/deep-student/issues/51)) ([f6690e9](https://github.com/asssssscaiyc/deep-student/commit/f6690e960585f0338d96b95146479ec3566c036b))


### Performance Improvements

* add cache-control headers and proper content-types for R2 uploads ([78b2325](https://github.com/asssssscaiyc/deep-student/commit/78b23254cb80984bbc7f810f81a63b07b612c601))
* **bundle:** optimize initial load performance with lazy loading and selective subscriptions ([0da3cba](https://github.com/asssssscaiyc/deep-student/commit/0da3cbab0f0d3a1b7ebd8315d3354c1c31f88d83))
* optimize view switching with memoization and ref-based state tracking ([2dc59c2](https://github.com/asssssscaiyc/deep-student/commit/2dc59c2b6a0cb15d2a274579ac91d3108fb787f6))
* **vfs:** optimize index status query with CTE aggregation and add performance indexes ([f2b2c99](https://github.com/asssssscaiyc/deep-student/commit/f2b2c995468de2ef3eb629cab3083ecf430f0161))
